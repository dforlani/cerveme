...
class VeiculoDetalheActivity_old:AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState:Bundle?) {
        ...
        progressDialog = ProgressDialog(this@VeiculoDetalheActivity_old)
        ...
        btneditar.setOnClickListener { v ->
            val i = Intent(v.context, AddVeiculo_old::class.java)
        ...
        btnremover.setOnClickListener {
            ...
            lista[0] = "Sim"
            lista[1] = "Não"
            val builder = AlertDialog.Builder(this@VeiculoDetalheActivity_old)
                ...
                if (which == 0) {
                    ...
                    val stringRequest = object:StringRequest(Request.Method.POST,
                        ...
                        try {
                            ...
                            Toast.makeText(this@VeiculoDetalheActivity_old, response, Toast.LENGTH_LONG).show()
                            val i = Intent(this@VeiculoDetalheActivity_old, MainActivity::class.java)
                            i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP)
                            startActivity(i)
                        } catch (e:Exception) {
                            Toast.makeText(this@VeiculoDetalheActivity_old, "Problemas na comuncação com o servidor.", Toast.LENGTH_SHORT).show()
                            e.printStackTrace()
                            progressDialog.cancel()
                        }
                    }, Response.ErrorListener {
                        progressDialog.cancel()
                        Toast.makeText(this@VeiculoDetalheActivity_old,
